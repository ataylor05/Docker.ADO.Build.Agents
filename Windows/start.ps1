...
$env:VSO_AGENT_IGNORE = "$env:VSO_AGENT_IGNORE,ADO_AGENT_URL,ANT_URL,CLOUD_FOUNDRY_CLI_URL,DOTNET_CORE_URL,GCLOUD_SDK_URL,GO_URL,GRADLE_URL,PYTHON3_URL,HELM2_URL,HELM3_URL,JDK_URL,JQ_URL,CMAKE_URL,CURL_URL,GIT_URL,PACKER_URL,TERRAFORM_URL,VAULT_URL"
